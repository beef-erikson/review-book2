...
{
    new Cat { Name = "Karen", Born = new(year: 2020, month: 05, day: 02),
        Legs = 4, IsDomestic = true},
    null,
    new Cat { Name = "Mufasa", Born = new(year: 1994, month: 6, day: 12)},
    new Spider { Name = "Sid Vicious", Born = DateTime.Today, IsPoisonous = false }
};
...
foreach (Animal? animal in animals)
{
    ...
    // alternatively, we can use a switch expression
